...
import type { BrandingSettings as _BrandingSettings, EngineeringInputs as _EngineeringInputs, Project as _Project, ProjectStatus as _ProjectStatus, StripeSessionStatus as _StripeSessionStatus, SubscriptionTier as _SubscriptionTier, Time as _Time, User as _User, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addComment(arg0: bigint, arg1: string, arg2: {
        x: number;
        y: number;
        z: number;
    }, arg3: string): Promise<Comment> {
        if (this.processError) {
            try {
    ...
    async createProject(arg0: string, arg1: string, arg2: EngineeringInputs, arg3: BrandingSettings): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createSharedLink(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createSharedLink(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProject(arg0: bigint): Promise<Project> {
        if (this.processError) {
            try {
                ...
                return from_candid_Project_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getProjectByShareToken(arg0: string): Promise<Project | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectByShareToken(arg0);
    ...
    async getUser(arg0: Principal): Promise<User> {
        if (this.processError) {
            try {
                ...
                return from_candid_User_n22(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async listProjectsByOwner(arg0: Principal): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.listProjectsByOwner(arg0);
    ...
    async saveErectionData(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveErectionData(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setStripeCustomerId(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setStripeCustomerId(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBrandingSettings(arg0: bigint, arg1: BrandingSettings): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateEngineeringInputs(arg0: bigint, arg1: EngineeringInputs): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEngineeringInputs(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProjectStatus(arg0: bigint, arg1: ProjectStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProjectStatus(arg0, to_candid_ProjectStatus_n27(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSubscriptionTier(arg0: Principal, arg1: SubscriptionTier): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSubscriptionTier(arg0, to_candid_SubscriptionTier_n29(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    engineeringInputs: _EngineeringInputs;
    ownerId: Principal;
    name: string;
    createdAt: _Time;
    uploadedFileName: string;
    ...
    return {
        ...
        engineeringInputs: value.engineeringInputs,
        ownerId: value.ownerId,
        name: value.name,
        createdAt: value.createdAt,
        uploadedFileName: value.uploadedFileName,
        updatedAt: value.updatedAt,
        erectionDataJSON: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.erectionDataJSON)),
...
function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        createdAt: value.createdAt,
        subscriptionTier: from_candid_SubscriptionTier_n24(_uploadFile, _downloadFile, value.subscriptionTier),
        email: value.email,
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "queued" in value ? ProjectStatus.queued : "processed" in value ? ProjectStatus.processed : "processing" in value ? ProjectStatus.processing : "failed" in value ? ProjectStatus.failed : value;
}
...
function from_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Project>): Array<Project> {
...
function to_candid_SubscriptionTier_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubscriptionTier): _SubscriptionTier {
...
function to_candid_variant_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectStatus): {
    ...
    return value == ProjectStatus.queued ? {
        queued: null
    } : value == ProjectStatus.processed ? {
        processed: null
    } : value == ProjectStatus.processing ? {
        processing: null
    } : value == ProjectStatus.failed ? {
        failed: null
    } : value;
}
function to_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubscriptionTier): {
    pro: null;
} | {
    free: null;
} {
